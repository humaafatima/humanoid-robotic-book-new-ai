...
const config = {
  ...
  baseUrl: '/humanoid-robotic-book-new-ai/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'humaafatima', // Usually your GitHub org/user name.
  projectName: 'humanoid-robotic-book-new-ai', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Physical AI Robotics Team. Built with Docusaurus.`,
      },
      prism: {
